                        ...
                        <div className="navbar-nav ms-auto p-4 p-lg-0">
                            ...
                            <div className="nav-item dropdown">
                                ...
                                <div className="dropdown-menu bg-light m-0">
                                    <NavLink to="/Feat" className="dropdown-item">Features</NavLink>
                                    <NavLink to="/qua" className="dropdown-item">Free Quote</NavLink>
                                    <NavLink to="/our" className="dropdown-item">Our Team</NavLink>
