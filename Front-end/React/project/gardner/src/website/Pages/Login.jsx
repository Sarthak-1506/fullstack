      ...
      <MDBRow className='d-flex justify-content-center align-items-center h-100'>
        <MDBCol col='12'>
          ...
          <form action="">
              ...
              <MDBInput wrapperClass='mb-4 w-100' value={form.email} name='email' onChange={getchange} label='Email' id='formControlLg' type='email' size="lg"/>
              ...
              <h5>New Account <Link  to="/register">Sign up </Link></h5>
